...
export const Route = createFileRoute('/login/')({
  beforeLoad: async ({ search }: { search: LoginSearch }) => {
    const isAuthenticated = await checkAuth()

    if (isAuthenticated) {
      const redirectTo = search.redirect || '/employees'
...
function LoginPage() {
  ...
  placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 
  sm:text-sm'
            ...
            <div>
              ...
              <input
                ...
                required
                className='appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 
  placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 
  sm:text-sm'
